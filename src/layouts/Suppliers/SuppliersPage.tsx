...
export default function SuppliersPage() {
  ...
  return (
    <div className=" w-full p-20 flex flex-wrap  gap-4 items-center justify-center">
      {/* <SuppliersForm /> */}
      <Card
        onClick={() => {
          navigate("./new");
      ...
      >
        <PlusCircleIcon className="size-10 w-full h-3/6 p-30" />
        <CardFooter className="w-full text-center">
          <h3 className="text-2xl w-full font-bold">Crear Proveedor</h3>
        </CardFooter>
      </Card>
      <Card
        onClick={() => {
