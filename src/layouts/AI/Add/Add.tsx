...
export default function Add() {
  ...
  const handleSuccess = (data: unknown) => {
    ...
    toast.success("Depósito procesado con éxito");
  };
            ...
            <div className="border rounded-lg p-4 mb-4">
              <div className="flex items-center mb-2">
                ...
                <span className="font-medium">
                  {response.verified ? "Depósito exitoso" : "Depósito fallido"}
                </span>
              </div>
      ...
      <div className="container max-w-4xl py-8">
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold">Agregar</h2>
              <p className="text-muted-foreground">
                Agregar dinero o productos
              </p>
            </div>
          </div>
          ...
          <FileUploader
            title="Agregar Billetes"
            description="Sube imágenes de billetes para agregar"
            maxFiles={100}
            maxFileSizeMB={20}
            endpoint="/ai/add-bills"
            method="post"
            additionalFormData={{
